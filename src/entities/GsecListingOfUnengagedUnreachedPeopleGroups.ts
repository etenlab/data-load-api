...
@Index('gsec_listing_of_unengaged_unreached_people_groups_pkey', ['id'], {
  unique: true,
})
@Entity('gsec_listing_of_unengaged_unreached_people_groups', {
  schema: 'public',
})
export class GsecListingOfUnengagedUnreachedPeopleGroups {
  ...
  @Column('boolean', { name: 'evangelical_engagement', nullable: true })
  evangelicalEngagement: boolean | null;
  ...
  @Column('character varying', {
    name: 'rop_people_name',
    nullable: true,
    length: 200,
  })
  ropPeopleName: string | null;
  ...
  @Column('character varying', { name: 'ror', nullable: true, length: 10 })
  ror: string | null;

  @Column('boolean', { name: 'diaspora', nullable: true })
