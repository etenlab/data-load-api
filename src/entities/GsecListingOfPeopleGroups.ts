...
@Index('gsec_listing_of_people_groups_pkey', ['id'], { unique: true })
@Entity('gsec_listing_of_people_groups', { schema: 'public' })
export class GsecListingOfPeopleGroups {
  ...
  @Column('boolean', { name: 'written_scripture', nullable: true })
  writtenScripture: boolean | null;
