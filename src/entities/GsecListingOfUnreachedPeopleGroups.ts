...
@Index('gsec_listing_of_unreached_people_groups_pkey', ['id'], { unique: true })
@Entity('gsec_listing_of_unreached_people_groups', { schema: 'public' })
export class GsecListingOfUnreachedPeopleGroups {
